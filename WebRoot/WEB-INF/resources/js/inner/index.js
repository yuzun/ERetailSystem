...
(function ($) {
    ...
    window.mainpage.loadMenu = function (id) {
        ...
        if ($.array.contains(["01", "02", "03"], id)) {
            $.get("resources/data/" + id +"-menu-data.json", function (menus) {
    ...
    window.mainpage.loadNavMenus = function (callback) {
        ...
        $.get("resources/data/menu-data.json", function (menus) {
...
//            	console.log(node.target.baseURI);
    ...
    window.mainpage.loadFavoMenus = function () {
        ...
        $(favoMenuTree).tree("load", "resources/data/favo-menu-data.json");
    };
    ...
    window.mainpage.addModuleTab = function (node) {
        ...
        if (!opts.href) { return; }
//        var temp = $.string.replaceAll(opts.target.baseURI, "//", "/");
//        var tempArray = temp.split("/");
//        opts.href = tempArray[tempArray.length - 2] + opts.href;
...
//    };
    ...
    window.link.reload = function () {
        ...
        $.ajax({
            url: "resources/data/link-data.json", type: "get", dataType: "json",
